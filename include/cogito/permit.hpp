...
// G0 결정   : G0-31 (docs/g0/G0-RESOLUTION-9.md ⑨ :590-640), ADR-0001 D4
//             G0-05 (docs/g0/G0-RESOLUTION-9.md ② :106-170) — 잠금 키(operation_digest)와
//             멱등 키(action_digest)의 분리. Permit 이 담는 것은 후자다.
//
