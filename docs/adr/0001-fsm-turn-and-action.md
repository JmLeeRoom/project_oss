...
- **상태**: **Accepted** (2026-08-27: S3 Core FSM D1·D2·D3·D5·D6 승인 확정, D4 재진입 카운터는 S4/S5 Permission Gate 로 이관)
- **날짜**: 2026-08-21 (승인일: 2026-08-27)
- **결정권자**: 아키텍트, 안전 책임자
- **관련 G0**: G0-24 (Accepted), G0-31 (S4/S5 Gate 배정)
